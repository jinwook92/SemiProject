...
<script>
    ...
    <form method="get" action="logic.do" name="frm">
...
<table class="table table-hover" id="aa">
    ...
    <tr>
        <td>파일이름</td>
        <td><a href="download.down?fname=<%=data.getFname()%>"><%=data.getFname()%>
        </a></td>
    </tr>
</table>
...
<button onclick='deldata("<%=data.getBoardnum()%>","<%=data.getFname()%>")'>삭제</button>
<br>
